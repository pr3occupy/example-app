...
export default function MotionTrail() {
    ...
    useEffect(() => {
        ...
        fragmentShader: `
            ...
            void main () {
                ...
                gl_FragColor = vec4(inputColor * 0.980);
            }
            `,
            transparent: true
        })
        ...
        function onMouseMove (e) {
            ...
            const y = (1 - e.clientY / innerHeight) * 2 - 1
    ...
    return (
        <div className="image-smear-page" ref={ref}>
        </div>
    )
}

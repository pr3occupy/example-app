...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.li variants={fadeIn}><Link prefetch={false} href="/haxor">HAXOR</Link></motion.li>
        <motion.li variants={fadeIn}><Link prefetch={false} href="/interaction">Ghaadi</Link></motion.li>
